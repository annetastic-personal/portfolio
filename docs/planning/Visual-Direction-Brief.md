...
| Card width                 | Full available width up to a compact maximum (`max-w-sm`)                             | Keeps the vertical card proportionate while giving the project preview more room to breathe.               |
