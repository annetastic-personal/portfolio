// ============================================================================
// Publishes wiki content to the GitHub wiki repo.
//
// Source of truth is docs/wiki (tracked, hand-authored markdown). This script
// clones the wiki into a disposable build folder (docs/.wiki-build), copies
// docs/wiki over it, and commits/pushes only if something actually changed.
// Safe to rerun anytime — it never generates content, it only publishes
// whatever is currently in docs/wiki.
// ============================================================================
...
(async () => {
  ...
  await wikiGit.commit("Publish wiki content");
  await wikiGit.push();
